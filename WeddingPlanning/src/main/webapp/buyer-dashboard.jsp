        ...
        <aside class="sidebar">
            ...
            <nav class="nav-menu">
                ...
                <ul class="nav-list">
                    ...
                    <li class="nav-item">
                        <a href="#bookings" class="nav-link active">
            ...
            <nav class="nav-menu">
                <h3 class="nav-title">Planning & Details</h3>
                <ul class="nav-list">
                    ...
                    <li class="nav-item">
                        <a href="#budget" class="nav-link active">
                            <i class="fas fa-piggy-bank"></i>
                            Wedding Budget
                        </a>
                    </li>
        ...
        <main class="main-content">
            ...
            <div class="welcome-banner">
                <div class="welcome-content">
                    <h1>Welcome Back</h1>
                    <p>Your special day is getting closer! Let's make your dream wedding perfect.</p>
                </div>
                <div class="countdown-container">
                    <div class="countdown-value">49</div>
            ...
            <div class="dashboard-grid">
                <div class="dashboard-card">
                    ...
                    <div class="wedding-details">
                        ...
                        <div class="detail-item">
                            ...
                            <span class="value">Rose Garden Palace</span>
                        </div>
                        <div class="detail-item">
                            <span class="label">Guests</span>
                            <span class="value">250 Loved Ones</span>
                        </div>
                        <div class="detail-progress">
                            ...
                            <span class="progress-label">Planning Complete</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="dashboard-card">
                    <div class="card-header">
                        <h3 class="card-title">Wedding Budget</h3>
                        <div class="card-icon">
                ...
                <div class="dashboard-card">
                    <div class="card-header">
                        <h3 class="card-title">Wedding Tasks</h3>
                        <div class="card-icon">
            ...
            <!-- Continue with vendor bookings and functions sections... -->
